...
public class GattServerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkQuickPermission();

        mLocalTimeView = (TextView) findViewById(R.id.text_time);
        test_alert = (TextView) findViewById(R.id.text_alert);
    ...
    private BluetoothGattServerCallback mGattServerCallback = new BluetoothGattServerCallback() {
        ...
        public void onCharacteristicWriteRequest(BluetoothDevice device, int requestId,
           ...
           //final int value_look = unsignedIntFromBytes(value);

            Log.i(TAG, "Sending update to " + mRegisteredDevices.size() + " subscribers");

            GattServerActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(getBaseContext(), "Received = "+ s, Toast.LENGTH_SHORT).show();
                    test_alert.setText(s);
                }
            });
    ...
    private void checkQuickPermission() {
